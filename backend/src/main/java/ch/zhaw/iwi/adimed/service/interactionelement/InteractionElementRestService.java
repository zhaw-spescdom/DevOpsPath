...
import ch.zhaw.iwi.adimed.model.interactionelement.form.FormValueFieldElement;
import ch.zhaw.iwi.adimed.model.interactionstep.InteractionStep;
import ch.zhaw.iwi.adimed.model.patient.Patient;
import ch.zhaw.iwi.adimed.model.questionnaireresponse.QuestionnaireResponse;
import ch.zhaw.iwi.adimed.model.questionnaireresponse.value.InteractionElementDoubleValue;
import ch.zhaw.iwi.adimed.model.questionnaireresponse.value.InteractionElementFileValue;
import ch.zhaw.iwi.adimed.model.questionnaireresponse.value.InteractionElementLongValue;
import ch.zhaw.iwi.adimed.model.questionnaireresponse.value.InteractionElementTextValue;
import ch.zhaw.iwi.adimed.model.questionnaireresponse.value.InteractionElementValue;
import ch.zhaw.iwi.adimed.service.AbstractCrudRestService;
import ch.zhaw.iwi.adimed.service.DateUtility;
import ch.zhaw.iwi.adimed.service.PathListEntry;
import ch.zhaw.iwi.adimed.service.exception.BackendValidationException;
import ch.zhaw.iwi.adimed.service.file.FileDatabaseService;
import ch.zhaw.iwi.adimed.service.interactionelement.gui.FormValueFieldElementGuiModel;
...
import ch.zhaw.iwi.adimed.service.patient.PatientDatabaseService;
import ch.zhaw.iwi.adimed.service.questionnaireresponse.QuestionnaireResponseDatabaseService;
import ch.zhaw.iwi.adimed.service.questionnaireresponse.value.InteractionElementValueDatabaseService;
