...
import ch.zhaw.iwi.adimed.server.CorsHeaders;
import ch.zhaw.iwi.adimed.server.Database;
import ch.zhaw.iwi.adimed.service.exception.ExceptionRestService;
...
import ch.zhaw.iwi.adimed.service.interactionelement.button.ButtonSelectionElementRestService;
import ch.zhaw.iwi.adimed.service.interactionelement.button.ButtonSelectionElementValueRestService;
import ch.zhaw.iwi.adimed.service.interactionelement.form.FormDateFieldElementRestService;
import ch.zhaw.iwi.adimed.service.interactionelement.form.FormFileTypeRestService;
import ch.zhaw.iwi.adimed.service.interactionelement.form.FormFileUploadElementRestService;
...
import ch.zhaw.iwi.adimed.service.interactionelement.list.ButtonListElementRestService;
import ch.zhaw.iwi.adimed.service.interactionelement.list.TileListElementRestService;
...
import ch.zhaw.iwi.adimed.service.language.LanguageUtility;
import ch.zhaw.iwi.adimed.service.mockup.MockupRestService;
import ch.zhaw.iwi.adimed.service.patient.PatientRestService;
import ch.zhaw.iwi.adimed.service.questionnaire.QuestionnaireRestService;
import ch.zhaw.iwi.adimed.service.questionnaireresponse.QuestionnaireResponseRestService;
import ch.zhaw.iwi.adimed.service.sport.SportRestService;
import ch.zhaw.iwi.adimed.service.user.UserRestService;
import ch.zhaw.iwi.adimed.service.user.permission.PermissionFunctionRestService;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		logger.info("adimed prototype running on localhost:" + getHerokuAssignedPort());
	}
