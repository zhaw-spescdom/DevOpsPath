...
import {AdimedTranslationService} from "./adimed-translation-service";
...
@Component({
    ...
    providers: [PathService, {provide: TranslationService, useClass: AdimedTranslationService}]
})
export class AdimedAppComponent extends PathAppComponent {
